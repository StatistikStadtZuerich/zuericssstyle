...
- **Sara Hänzi**. Author, maintainer.

- **Alessandro Feller**. Author.

- **Statistik Stadt Zürich (SSZ)**. Copyright holder, funder.
...
styling for shiny apps and html*. R package version 2.0.1,
