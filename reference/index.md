...
Functions for getting css files

- [`get_css_core()`](https://statistikstadtzuerich.github.io/zuericssstyle/reference/get_css_core.md)
  : get_css_core
- [`get_generic_css()`](https://statistikstadtzuerich.github.io/zuericssstyle/reference/get_generic_css.md)
  : get_generic_css

## Shiny pages and html dependencies

Functions creating shiny pages with zuericssstyle and to add html
dependency for any html object
